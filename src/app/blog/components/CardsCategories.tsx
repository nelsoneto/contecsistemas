  ...
  return (
    <div className="mb-20 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
      {posts.map((post, index) => (
        <Card
          key={index}
          className="overflow-hidden rounded-lg border-none bg-gray-100 shadow-xl transition delay-150 ease-in-out hover:-translate-y-1 hover:scale-100 hover:outline hover:outline-offset-2 hover:outline-blue-500"
        >
